            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-amber-400/80">
                  You have <strong className="text-amber-300">{a.total_mistakes}</strong> wrong
                  answers across your quizzes
                </p>
          ...
          <div className="mb-4 animate-slide-down rounded-xl border border-synapse-neon-red/20 bg-synapse-neon-red/5 px-4 py-3 text-xs text-synapse-neon-red">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="ml-auto text-synapse-neon-red/60 hover:text-synapse-neon-red"
              >
                <svg
          ...
          <section className="mb-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {quizHistory.slice(0, 10).map((q) => {
                const pct =
                  q.score !== null && q.total_points && q.total_points > 0
                ...
                return (
                  <div
                    key={q.id}
                    className="glass-card p-4 transition-all duration-200 hover:border-synapse-neon-purple/20 hover:shadow-card-hover"
                  >
