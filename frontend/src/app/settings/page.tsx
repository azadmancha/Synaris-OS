...
const SUBJECTS = [
  ...
  { value: 'biology', label: '🧬 Biology', desc: 'Genetics, Ecology, Cell Biology, Evolution' },
  {
    ...
    desc: 'Programming, AI, Data Structures, Algorithms',
  },
      ...
      <ErrorBoundary componentName="SettingsPage">
        <div className="relative">
          ...
          <form onSubmit={handleSave} className="relative z-10 space-y-6">
            ...
            <section className="glass-card animate-slide-up overflow-hidden p-6">
              <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href="/onboarding"
                    className="mt-1 inline-block text-[10px] text-synapse-neon-blue hover:text-blue-400 transition-colors"
                  >
              ...
              <div className="space-y-4">
                <div>
                  <label className="mb-1.5 block text-xs font-medium text-glass-secondary">
                    Display Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-right text-[10px] text-glass-tertiary">
                    {bio.length}/500
                  </p>
                </div>
              </div>
            ...
            <section
              className="glass-card animate-slide-up overflow-hidden p-6"
              style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}
            >
              <h2 className="mb-5 text-lg font-semibold text-glass-primary">
                Learning Preferences
              </h2>

              <div className="mb-6">
                <label className="mb-3 block text-xs font-medium text-glass-secondary">
                  Interested Subjects
                </label>
                ...
                <div className="inline-flex rounded-xl border border-gray-300 dark:border-white/10 bg-gray-100 dark:bg-white/[0.03] p-1">
                  {DEPTHS.map((d) => (
                    <button
                      key={d.value}
                      type="button"
                      onClick={() => setDefaultMode(d.value)}
            ...
            {/* Danger Zone */}
            <section
              className="glass-card animate-slide-up overflow-hidden border-red-500/20 p-6"
              style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}
            >
              <h2 className="mb-2 text-sm font-semibold text-synapse-neon-red">Danger Zone</h2>
              <p className="mb-4 text-xs text-glass-tertiary">
