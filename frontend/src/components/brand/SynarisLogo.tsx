    ...
    <>
      ...
      >
        ...
        <path
          ...
          fill="none"
          style={animated ? { strokeDasharray: 60, strokeDashoffset: 60, animation: `nd-${uid} 2s ease-out forwards` } : {}}
        />
        ...
        <circle cx="25" cy="20" r="1.5" fill="#8B5CF6" opacity="0.9" filter={`url(#${glowSoftId})`} />
        ...
        <line x1="14" y1="17" x2="17" y2="17" stroke="#6366F1" strokeWidth="1" strokeDasharray="2 2" opacity="0.4" />
        <line x1="23" y1="23" x2="26" y2="23" stroke="#6366F1" strokeWidth="1" strokeDasharray="2 2" opacity="0.4" />
      </svg>
    </>
  );
}
...
export function SynarisWordmark({
  ...
  return (
    ...
    >
      ...
      <div className={`flex ${stacked ? 'flex-col items-center' : 'items-baseline'} ${stacked ? '' : 'gap-0'}`}>
        <span
...
export function SynarisAppIcon({ size = 512 }: { size?: number }) {
  ...
  return (
    ...
    >
      ...
      <circle cx="256" cy="256" r="140" stroke="white" strokeWidth="0.5" opacity="0.06" strokeDasharray="8 8" />

      {/* Neural S Path */}
      <path
        d="M180 160C180 160 210 120 260 140C310 160 310 220 270 250C230 280 190 260 170 300C150 340 190 380 260 380"
        stroke="white" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.9"
      />
      ...
      {/* Sparkle */}
      <path d="M350 130L355 145L370 150L355 155L350 170L345 155L330 150L345 145Z" fill="white" opacity="0.6" />
    </svg>
  );
}
