...
export function ChatSidebar({
  ...
  return (
    <>
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-gray-200 bg-white/95 backdrop-blur-xl transition-all duration-300 dark:border-gray-700 dark:bg-[#0F1117]/95 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:relative lg:translate-x-0`}
      >
        {/* Sidebar Header */}
        ...
        <div className="p-3">
          <button
            onClick={onNewChat}
            className="flex w-full items-center gap-2 rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 transition-all hover:border-gray-300 hover:bg-gray-50 active:scale-[0.98] dark:border-gray-600 dark:text-gray-300 dark:hover:border-gray-500 dark:hover:bg-[#1C1E2B]"
          >
            <svg
              className="h-4 w-4"
              fill="none"
        ...
        <div className="border-t border-gray-100 p-3 dark:border-gray-800">
          {user && (
            <div className="space-y-2">
              <a
                href="/settings"
                className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-xs text-gray-400 transition-colors hover:bg-gray-50 hover:text-gray-600 dark:hover:bg-[#1C1E2B] dark:hover:text-gray-300"
              >
                <svg
                  className="h-3.5 w-3.5"
                  fill="none"
              ...
              <a
                href="/onboarding"
                className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-[10px] text-gray-400 transition-colors hover:bg-gray-50 hover:text-gray-600 dark:hover:bg-[#1C1E2B] dark:hover:text-gray-300"
              >
